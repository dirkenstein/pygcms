...
class DictionaryTreeDialog(QtWidgets.QDialog):
		...
		def __init__(self, d):
				...
				treeWidget.header().setSectionResizeMode(0, QtWidgets.QHeaderView.ResizeToContents)
				treeWidget.header().setSectionResizeMode(1, QtWidgets.QHeaderView.ResizeToContents)
				...
				self.buttonCancel.clicked.connect(self.closeCancel)
...
if __name__=='__main__':
		...
		newd = json.dumps(edited_dict, indent=4)
		f = open("upd.json", "w")
		f.write(newd)
		f.close()
